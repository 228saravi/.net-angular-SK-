...
namespace SK.Database.Migrations
{
    ...
    [Migration("20180915072935_Changes_2018_09_15_001")]
    partial class Changes_2018_09_15_001
    {
            ...
            modelBuilder.Entity("SK.Database.Segment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "Middle", Name = "Стандарт", Rank = 0 },
                        new { Id = "Premium", Name = "Премиум", Rank = 0 }
                    );
                });
